...
把海洋经济当成一家「巨型企业」的数字镜像：家底 / 经营 / 质量 / 政策底座。
...
海洋系列是监测产品，公开数据与周报会过期，应周期性更新：

- **A 家底**：企业名录 / 三表画像 / 节点地图采集
- **B 经营**：政策口径、产业数据、招标雷达
- **C 质量**：海温 / 港口 / AIS / 灾害 / 企业风险信号
- **D 底座**：按期写周报并归档
...
把历代城图、旧照片与文献考据做成能放大细读的离线专题；主线是「城市自己怎么长出来的」。

| 站点 | 备注 | Pages |
|---|---|---|
| 数字广州 · 城脉千年 | 历代城图与城市考古 · 69 幅古地图 · 数据考据档案馆 37 条 | [chengmai-qiannian](http://wangdw.xyz/chengmai-qiannian/) |
...
这些仓库存在，但不是本门户的常用 Pages 卡片（无独立产品壳，或只是重复目录 / 非站点服务）：

| 仓库 | 说明 |
|---|---|
| [sites](https://github.com/wangdwn/sites) | 旧版站点索引，功能已由本仓库 `index.html` 取代 |
| [tg-relay](https://github.com/wangdwn/tg-relay) | Telegram API relay，非 Pages 产品 |
| [telegram-bot](https://github.com/wangdwn/telegram-bot) | 机器人，非 Pages 产品 |

根域仓库本身：本站（[wangdwn.github.io](https://github.com/wangdwn/wangdwn.github.io)）。

---

## 维护约定

1. **新站点**：先写入本文件对应栏目，再在 `index.html` 加一张卡片；同一 URL 不要出现在两个栏目。
...
6. **数字人文**：新专题先进本栏目；古地图类须先过地图审图与图源授权，未过审的只留本地离线版，不上线。
